...
Preferred dataset format for this task is Pascal VOC format, originally used here [1]. The absolute minimum is 100 images per model. 
...
The annotation can be generated for example using [2]. For the rendered images, all objects should be labeled. 
