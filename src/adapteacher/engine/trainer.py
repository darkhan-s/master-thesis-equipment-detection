...
from adapteacher.solver.build import build_optimizer
...
from adapteacher.engine.hooks import BestTSCheckpointer
...
class ATeacherTrainer(DefaultTrainer):
    def __init__(self, cfg):
        ...
        self.ensem_ts_model = ensem_ts_model
        ...
        #TODO: find correct input values
        # from torchinfo import summary
        # summary(ensem_ts_model, input_size=(1, 3, 300, 300))
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == "pascal_voc_tless":
            classes_to_load = cfg.MODEL.ROI_HEADS.OLD_CLASSES + list(set(cfg.MODEL.ROI_HEADS.NEW_CLASSES) - set(cfg.MODEL.ROI_HEADS.OLD_CLASSES))
            return PascalVOCDetectionEvaluator(dataset_name, target_classnames=classes_to_load)
    ...
    def run_step_full_semisup(self):
        ...
        if self.iter < self.cfg.SEMISUPNET.BURN_UP_STEP:
            ...
            ##TODO: check if this should be commented out
            ...
            for key in record_dict.keys():
                if key.startswith("loss"):
                    if key == "loss_rpn_loc_pseudo" or key == "loss_box_reg_pseudo":
                        ...
                        key == "loss_D_img_s" or key == "loss_D_img_t" or key == "loss_D_img_low_s" or key == "loss_D_img_low_t"
    ...
    def build_hooks(self):
        ...
        if cfg.SOLVER.BEST_CHECKPOINTER and comm.is_main_process():
            ret.append(BestTSCheckpointer(cfg.TEST.EVAL_PERIOD, self.checkpointer, cfg.SOLVER.BEST_CHECKPOINTER.METRIC, mode=cfg.SOLVER.BEST_CHECKPOINTER.MODE, patience = cfg.SOLVER.BEST_CHECKPOINTER.PATIENCE))
        ...
        def test_and_save_results_teacher():
            ...
            self._last_eval_results_teacher = {
