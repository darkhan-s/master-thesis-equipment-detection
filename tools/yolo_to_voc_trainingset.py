...
## path root folder
ROOT = '/scratch/project_2005695/Transfer-Learning-Library/examples/domain_adaptation/object_detection/datasets/TLESS_rendered_dataset'
...
def xml_transform(root, classes):  
    ...
    for i in range(len(ids)):
        ...
        node_folder.text = 'TLESS_rendered_dataset'
        img_name = img_id + '.jpg'
